...
import { Pokemon } from '../../../Interfaces/typeRequest.interface';
  ...
  ngOnInit(): void {
    ...
    this.activatedRoute.params.subscribe( params =>{
      ...
      .subscribe( result =>{
        ...
        this.currentPokemonList = result.pokemon.slice(0,10);

        this.totalPages = Math.ceil(result.pokemon.length / 10);
      })
    })
